...
public sealed class UpdateBasketTest(ITestOutputHelper output) : BaseEfRepoTestFixture
{
    ...
    public void ShouldBeUpdateBasket()
    {
        ...
        _redisService.HashGetOrSet($"user:{customerId}:basket", customerId.ToString(), () => basket);
