...
public class TestLivenessEndpoint(WebApplicationFactory<Program> factory) : IClassFixture<WebApplicationFactory<Program>>
{
    [Fact]
    public async Task ShouldBeReturnOk()
    {
        ...
        var client = factory
            ...
            {
                builder.UseSetting("ConnectionStrings:Postgres", "Host=localhost;Port=5432;Database=test_db;Username=postgres;Password=postgres");
