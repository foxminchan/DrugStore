...
namespace DrugStore.Persistence.Migrations
{
    ...
    [Migration("20240307112441_Update-Value-Converter")]
    partial class UpdateValueConverter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrugStore.Domain.CategoryAggregate.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 593, DateTimeKind.Utc).AddTicks(8971))
                    ...
                    b.Property<DateTime?>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 594, DateTimeKind.Utc).AddTicks(1202))
            ...
            modelBuilder.Entity("DrugStore.Domain.OrderAggregate.Card", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 590, DateTimeKind.Utc).AddTicks(4233))
                        .HasColumnName("created_date");
                    ...
                    b.Property<DateTime?>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 591, DateTimeKind.Utc).AddTicks(3618))
                        .HasColumnName("update_date");
            ...
            modelBuilder.Entity("DrugStore.Domain.OrderAggregate.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 596, DateTimeKind.Utc).AddTicks(2106))
                        .HasColumnName("created_date");
                    ...
                    b.Property<DateTime?>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 596, DateTimeKind.Utc).AddTicks(4225))
                        .HasColumnName("update_date");
            ...
            modelBuilder.Entity("DrugStore.Domain.OrderAggregate.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 600, DateTimeKind.Utc).AddTicks(6832))
                        .HasColumnName("created_date");
                    ...
                    b.Property<DateTime?>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 600, DateTimeKind.Utc).AddTicks(7456))
                        .HasColumnName("update_date");
            ...
            modelBuilder.Entity("DrugStore.Domain.ProductAggregate.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 605, DateTimeKind.Utc).AddTicks(4669))
                        .HasColumnName("created_date");
                    ...
                    b.Property<DateTime?>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 3, 7, 11, 24, 40, 605, DateTimeKind.Utc).AddTicks(5272))
                        .HasColumnName("update_date");
