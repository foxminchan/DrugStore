...
namespace DrugStore.Persistence.CompiledModels
{
    internal partial class CardEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            createdDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 3, 4, 16, 58, 19, 423, DateTimeKind.Utc).AddTicks(6460));

            var cvc = runtimeEntityType.AddProperty(
                "Cvc",
                typeof(ushort?),
                propertyInfo: typeof(Card).GetProperty("Cvc", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Card).GetField("<Cvc>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
            ...
            var expiryMonth = runtimeEntityType.AddProperty(
                "ExpiryMonth",
                typeof(byte?),
                propertyInfo: typeof(Card).GetProperty("ExpiryMonth", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Card).GetField("<ExpiryMonth>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
            ...
            var expiryYear = runtimeEntityType.AddProperty(
                "ExpiryYear",
                typeof(ushort?),
                propertyInfo: typeof(Card).GetProperty("ExpiryYear", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Card).GetField("<ExpiryYear>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
        ...
        var number = runtimeEntityType.AddProperty(
            "Number",
            typeof(string),
            propertyInfo: typeof(Card).GetProperty("Number", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Card).GetField("<Number>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            maxLength: 16);
        number.TypeMapping = NpgsqlStringTypeMapping.Default.Clone(
            ...
            mappingInfo: new RelationalTypeMappingInfo(
                ...
                size: 16));
        number.TypeMapping = ((NpgsqlStringTypeMapping)number.TypeMapping).Clone(npgsqlDbType: NpgsqlTypes.NpgsqlDbType.Varchar);
    ...
    updateDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 3, 4, 16, 58, 19, 423, DateTimeKind.Utc).AddTicks(6876));
