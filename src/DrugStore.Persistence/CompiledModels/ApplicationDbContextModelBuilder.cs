...
public partial class ApplicationDbContextModel
{
    ...
    private IRelationalModel CreateRelationalModel()
    {
        ...
        var drugStoreDomainCategoryAggregateCategoryTableBase =
            new TableBase("DrugStore.Domain.CategoryAggregate.Category", null, relationalModel);
        var created_dateColumnBase = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone",
            drugStoreDomainCategoryAggregateCategoryTableBase);
        drugStoreDomainCategoryAggregateCategoryTableBase.Columns.Add("created_date", created_dateColumnBase);
        var idColumnBase =
            new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainCategoryAggregateCategoryTableBase);
        drugStoreDomainCategoryAggregateCategoryTableBase.Columns.Add("id", idColumnBase);
        var linkColumnBase = new ColumnBase<ColumnMappingBase>("link", "character varying(100)",
            drugStoreDomainCategoryAggregateCategoryTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainCategoryAggregateCategoryTableBase.Columns.Add("link", linkColumnBase);
        var titleColumnBase = new ColumnBase<ColumnMappingBase>("title", "character varying(50)",
            drugStoreDomainCategoryAggregateCategoryTableBase);
        drugStoreDomainCategoryAggregateCategoryTableBase.Columns.Add("title", titleColumnBase);
        var update_dateColumnBase = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone",
            drugStoreDomainCategoryAggregateCategoryTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainCategoryAggregateCategoryTableBase.Columns.Add("update_date", update_dateColumnBase);
        var versionColumnBase =
            new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainCategoryAggregateCategoryTableBase);
        drugStoreDomainCategoryAggregateCategoryTableBase.Columns.Add("version", versionColumnBase);
        relationalModel.DefaultTables.Add("DrugStore.Domain.CategoryAggregate.Category",
            drugStoreDomainCategoryAggregateCategoryTableBase);
        var drugStoreDomainCategoryAggregateCategoryMappingBase =
            new TableMappingBase<ColumnMappingBase>(category, drugStoreDomainCategoryAggregateCategoryTableBase, true);
        drugStoreDomainCategoryAggregateCategoryTableBase.AddTypeMapping(
            drugStoreDomainCategoryAggregateCategoryMappingBase, false);
        defaultTableMappings.Add(drugStoreDomainCategoryAggregateCategoryMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase, category.FindProperty("Id")!,
            drugStoreDomainCategoryAggregateCategoryMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase,
            category.FindProperty("CreatedDate")!, drugStoreDomainCategoryAggregateCategoryMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)linkColumnBase,
            category.FindProperty("Link")!, drugStoreDomainCategoryAggregateCategoryMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)titleColumnBase,
            category.FindProperty("Title")!, drugStoreDomainCategoryAggregateCategoryMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase,
            category.FindProperty("UpdateDate")!, drugStoreDomainCategoryAggregateCategoryMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase,
            category.FindProperty("Version")!, drugStoreDomainCategoryAggregateCategoryMappingBase);
        ...
        RelationalModel.CreateColumnMapping(created_dateColumn, category.FindProperty("CreatedDate")!,
            categoriesTableMapping);
        ...
        RelationalModel.CreateColumnMapping(update_dateColumn, category.FindProperty("UpdateDate")!,
            categoriesTableMapping);
        ...
        var drugStoreDomainCategoryAggregateNewsTableBase =
            new TableBase("DrugStore.Domain.CategoryAggregate.News", null, relationalModel);
        var category_idColumnBase =
            new ColumnBase<ColumnMappingBase>("category_id", "uuid", drugStoreDomainCategoryAggregateNewsTableBase)
            {
                IsNullable = true
            };
        drugStoreDomainCategoryAggregateNewsTableBase.Columns.Add("category_id", category_idColumnBase);
        var created_dateColumnBase0 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone",
            drugStoreDomainCategoryAggregateNewsTableBase);
        drugStoreDomainCategoryAggregateNewsTableBase.Columns.Add("created_date", created_dateColumnBase0);
        var detailColumnBase = new ColumnBase<ColumnMappingBase>("detail", "character varying(500)",
            drugStoreDomainCategoryAggregateNewsTableBase);
        drugStoreDomainCategoryAggregateNewsTableBase.Columns.Add("detail", detailColumnBase);
        var idColumnBase0 =
            new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainCategoryAggregateNewsTableBase);
        drugStoreDomainCategoryAggregateNewsTableBase.Columns.Add("id", idColumnBase0);
        var imageColumnBase = new ColumnBase<ColumnMappingBase>("image", "character varying(100)",
            drugStoreDomainCategoryAggregateNewsTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainCategoryAggregateNewsTableBase.Columns.Add("image", imageColumnBase);
        var titleColumnBase0 = new ColumnBase<ColumnMappingBase>("title", "character varying(50)",
            drugStoreDomainCategoryAggregateNewsTableBase);
        drugStoreDomainCategoryAggregateNewsTableBase.Columns.Add("title", titleColumnBase0);
        var update_dateColumnBase0 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone",
            drugStoreDomainCategoryAggregateNewsTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainCategoryAggregateNewsTableBase.Columns.Add("update_date", update_dateColumnBase0);
        var versionColumnBase0 =
            new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainCategoryAggregateNewsTableBase);
        drugStoreDomainCategoryAggregateNewsTableBase.Columns.Add("version", versionColumnBase0);
        relationalModel.DefaultTables.Add("DrugStore.Domain.CategoryAggregate.News",
            drugStoreDomainCategoryAggregateNewsTableBase);
        var drugStoreDomainCategoryAggregateNewsMappingBase =
            new TableMappingBase<ColumnMappingBase>(news, drugStoreDomainCategoryAggregateNewsTableBase, true);
        drugStoreDomainCategoryAggregateNewsTableBase.AddTypeMapping(drugStoreDomainCategoryAggregateNewsMappingBase,
            false);
        defaultTableMappings0.Add(drugStoreDomainCategoryAggregateNewsMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase0, news.FindProperty("Id")!,
            drugStoreDomainCategoryAggregateNewsMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)category_idColumnBase,
            news.FindProperty("CategoryId")!, drugStoreDomainCategoryAggregateNewsMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase0,
            news.FindProperty("CreatedDate")!, drugStoreDomainCategoryAggregateNewsMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)detailColumnBase,
            news.FindProperty("Detail")!, drugStoreDomainCategoryAggregateNewsMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)imageColumnBase, news.FindProperty("Image")!,
            drugStoreDomainCategoryAggregateNewsMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)titleColumnBase0,
            news.FindProperty("Title")!, drugStoreDomainCategoryAggregateNewsMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase0,
            news.FindProperty("UpdateDate")!, drugStoreDomainCategoryAggregateNewsMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase0,
            news.FindProperty("Version")!, drugStoreDomainCategoryAggregateNewsMappingBase);
        ...
        var drugStoreDomainCategoryAggregatePostTableBase =
            new TableBase("DrugStore.Domain.CategoryAggregate.Post", null, relationalModel);
        var category_idColumnBase0 =
            new ColumnBase<ColumnMappingBase>("category_id", "uuid", drugStoreDomainCategoryAggregatePostTableBase)
            {
                IsNullable = true
            };
        drugStoreDomainCategoryAggregatePostTableBase.Columns.Add("category_id", category_idColumnBase0);
        var created_dateColumnBase1 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone",
            drugStoreDomainCategoryAggregatePostTableBase);
        drugStoreDomainCategoryAggregatePostTableBase.Columns.Add("created_date", created_dateColumnBase1);
        var detailColumnBase0 = new ColumnBase<ColumnMappingBase>("detail", "character varying(500)",
            drugStoreDomainCategoryAggregatePostTableBase);
        drugStoreDomainCategoryAggregatePostTableBase.Columns.Add("detail", detailColumnBase0);
        var idColumnBase1 =
            new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainCategoryAggregatePostTableBase);
        drugStoreDomainCategoryAggregatePostTableBase.Columns.Add("id", idColumnBase1);
        var imageColumnBase0 = new ColumnBase<ColumnMappingBase>("image", "character varying(100)",
            drugStoreDomainCategoryAggregatePostTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainCategoryAggregatePostTableBase.Columns.Add("image", imageColumnBase0);
        var titleColumnBase1 = new ColumnBase<ColumnMappingBase>("title", "character varying(50)",
            drugStoreDomainCategoryAggregatePostTableBase);
        drugStoreDomainCategoryAggregatePostTableBase.Columns.Add("title", titleColumnBase1);
        var update_dateColumnBase1 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone",
            drugStoreDomainCategoryAggregatePostTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainCategoryAggregatePostTableBase.Columns.Add("update_date", update_dateColumnBase1);
        var versionColumnBase1 =
            new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainCategoryAggregatePostTableBase);
        drugStoreDomainCategoryAggregatePostTableBase.Columns.Add("version", versionColumnBase1);
        relationalModel.DefaultTables.Add("DrugStore.Domain.CategoryAggregate.Post",
            drugStoreDomainCategoryAggregatePostTableBase);
        var drugStoreDomainCategoryAggregatePostMappingBase =
            new TableMappingBase<ColumnMappingBase>(post, drugStoreDomainCategoryAggregatePostTableBase, true);
        drugStoreDomainCategoryAggregatePostTableBase.AddTypeMapping(drugStoreDomainCategoryAggregatePostMappingBase,
            false);
        defaultTableMappings1.Add(drugStoreDomainCategoryAggregatePostMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase1, post.FindProperty("Id")!,
            drugStoreDomainCategoryAggregatePostMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)category_idColumnBase0,
            post.FindProperty("CategoryId")!, drugStoreDomainCategoryAggregatePostMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase1,
            post.FindProperty("CreatedDate")!, drugStoreDomainCategoryAggregatePostMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)detailColumnBase0,
            post.FindProperty("Detail")!, drugStoreDomainCategoryAggregatePostMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)imageColumnBase0,
            post.FindProperty("Image")!, drugStoreDomainCategoryAggregatePostMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)titleColumnBase1,
            post.FindProperty("Title")!, drugStoreDomainCategoryAggregatePostMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase1,
            post.FindProperty("UpdateDate")!, drugStoreDomainCategoryAggregatePostMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase1,
            post.FindProperty("Version")!, drugStoreDomainCategoryAggregatePostMappingBase);
        ...
        var concurrency_stampColumnBase = new ColumnBase<ColumnMappingBase>("concurrency_stamp", "text",
            drugStoreDomainIdentityAggregateApplicationRoleTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationRoleTableBase.Columns.Add("concurrency_stamp",
            concurrency_stampColumnBase);
        var idColumnBase2 =
            new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainIdentityAggregateApplicationRoleTableBase);
        drugStoreDomainIdentityAggregateApplicationRoleTableBase.Columns.Add("id", idColumnBase2);
        var nameColumnBase = new ColumnBase<ColumnMappingBase>("name", "character varying(256)",
            drugStoreDomainIdentityAggregateApplicationRoleTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationRoleTableBase.Columns.Add("name", nameColumnBase);
        var normalized_nameColumnBase = new ColumnBase<ColumnMappingBase>("normalized_name", "character varying(256)",
            drugStoreDomainIdentityAggregateApplicationRoleTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationRoleTableBase.Columns.Add("normalized_name",
            normalized_nameColumnBase);
        relationalModel.DefaultTables.Add("DrugStore.Domain.IdentityAggregate.ApplicationRole",
            drugStoreDomainIdentityAggregateApplicationRoleTableBase);
        var drugStoreDomainIdentityAggregateApplicationRoleMappingBase =
            new TableMappingBase<ColumnMappingBase>(applicationRole,
        ...
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)concurrency_stampColumnBase,
            applicationRole.FindProperty("ConcurrencyStamp")!,
            drugStoreDomainIdentityAggregateApplicationRoleMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)nameColumnBase,
            applicationRole.FindProperty("Name")!, drugStoreDomainIdentityAggregateApplicationRoleMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)normalized_nameColumnBase,
        ...
        var access_failed_countColumnBase = new ColumnBase<ColumnMappingBase>("access_failed_count", "integer",
            drugStoreDomainIdentityAggregateApplicationUserTableBase);
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("access_failed_count",
            access_failed_countColumnBase);
        var concurrency_stampColumnBase0 = new ColumnBase<ColumnMappingBase>("concurrency_stamp", "text",
            drugStoreDomainIdentityAggregateApplicationUserTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("concurrency_stamp",
            concurrency_stampColumnBase0);
        var emailColumnBase = new ColumnBase<ColumnMappingBase>("email", "character varying(256)",
            drugStoreDomainIdentityAggregateApplicationUserTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("email", emailColumnBase);
        var email_confirmedColumnBase = new ColumnBase<ColumnMappingBase>("email_confirmed", "boolean",
            drugStoreDomainIdentityAggregateApplicationUserTableBase);
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("email_confirmed",
            email_confirmedColumnBase);
        var full_nameColumnBase = new ColumnBase<ColumnMappingBase>("full_name", "character varying(50)",
            drugStoreDomainIdentityAggregateApplicationUserTableBase);
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("full_name", full_nameColumnBase);
        var idColumnBase3 =
            new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainIdentityAggregateApplicationUserTableBase);
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("id", idColumnBase3);
        var lockout_enabledColumnBase = new ColumnBase<ColumnMappingBase>("lockout_enabled", "boolean",
            drugStoreDomainIdentityAggregateApplicationUserTableBase);
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("lockout_enabled",
            lockout_enabledColumnBase);
        var lockout_endColumnBase = new ColumnBase<ColumnMappingBase>("lockout_end", "timestamp with time zone",
            drugStoreDomainIdentityAggregateApplicationUserTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("lockout_end", lockout_endColumnBase);
        var normalized_emailColumnBase = new ColumnBase<ColumnMappingBase>("normalized_email", "character varying(256)",
            drugStoreDomainIdentityAggregateApplicationUserTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("normalized_email",
            normalized_emailColumnBase);
        var normalized_user_nameColumnBase = new ColumnBase<ColumnMappingBase>("normalized_user_name",
            "character varying(256)", drugStoreDomainIdentityAggregateApplicationUserTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("normalized_user_name",
            normalized_user_nameColumnBase);
        var password_hashColumnBase = new ColumnBase<ColumnMappingBase>("password_hash", "text",
            drugStoreDomainIdentityAggregateApplicationUserTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("password_hash", password_hashColumnBase);
        var phone_numberColumnBase = new ColumnBase<ColumnMappingBase>("phone_number", "character varying(10)",
            drugStoreDomainIdentityAggregateApplicationUserTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("phone_number", phone_numberColumnBase);
        var phone_number_confirmedColumnBase = new ColumnBase<ColumnMappingBase>("phone_number_confirmed", "boolean",
            drugStoreDomainIdentityAggregateApplicationUserTableBase);
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("phone_number_confirmed",
            phone_number_confirmedColumnBase);
        var security_stampColumnBase = new ColumnBase<ColumnMappingBase>("security_stamp", "text",
            drugStoreDomainIdentityAggregateApplicationUserTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("security_stamp",
            security_stampColumnBase);
        var two_factor_enabledColumnBase = new ColumnBase<ColumnMappingBase>("two_factor_enabled", "boolean",
            drugStoreDomainIdentityAggregateApplicationUserTableBase);
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("two_factor_enabled",
            two_factor_enabledColumnBase);
        var user_nameColumnBase = new ColumnBase<ColumnMappingBase>("user_name", "character varying(256)",
            drugStoreDomainIdentityAggregateApplicationUserTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainIdentityAggregateApplicationUserTableBase.Columns.Add("user_name", user_nameColumnBase);
        relationalModel.DefaultTables.Add("DrugStore.Domain.IdentityAggregate.ApplicationUser",
            drugStoreDomainIdentityAggregateApplicationUserTableBase);
        var drugStoreDomainIdentityAggregateApplicationUserMappingBase =
            new TableMappingBase<ColumnMappingBase>(applicationUser,
        ...
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)access_failed_countColumnBase,
            applicationUser.FindProperty("AccessFailedCount")!,
            drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)concurrency_stampColumnBase0,
            applicationUser.FindProperty("ConcurrencyStamp")!,
            drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)emailColumnBase,
            applicationUser.FindProperty("Email")!, drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)email_confirmedColumnBase,
            applicationUser.FindProperty("EmailConfirmed")!,
            drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)full_nameColumnBase,
            applicationUser.FindProperty("FullName")!, drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)lockout_enabledColumnBase,
            applicationUser.FindProperty("LockoutEnabled")!,
            drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)lockout_endColumnBase,
            applicationUser.FindProperty("LockoutEnd")!, drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)normalized_emailColumnBase,
            applicationUser.FindProperty("NormalizedEmail")!,
            drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)normalized_user_nameColumnBase,
            applicationUser.FindProperty("NormalizedUserName")!,
            drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)password_hashColumnBase,
            applicationUser.FindProperty("PasswordHash")!, drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)phone_numberColumnBase,
            applicationUser.FindProperty("PhoneNumber")!, drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)phone_number_confirmedColumnBase,
            applicationUser.FindProperty("PhoneNumberConfirmed")!,
            drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)security_stampColumnBase,
            applicationUser.FindProperty("SecurityStamp")!, drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)two_factor_enabledColumnBase,
            applicationUser.FindProperty("TwoFactorEnabled")!,
            drugStoreDomainIdentityAggregateApplicationUserMappingBase);
        ...
        card.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings5);
        var drugStoreDomainOrderAggregateCardTableBase =
            new TableBase("DrugStore.Domain.OrderAggregate.Card", null, relationalModel);
        var created_dateColumnBase2 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone",
            drugStoreDomainOrderAggregateCardTableBase);
        drugStoreDomainOrderAggregateCardTableBase.Columns.Add("created_date", created_dateColumnBase2);
        var cvcColumnBase =
            new ColumnBase<ColumnMappingBase>("cvc", "integer", drugStoreDomainOrderAggregateCardTableBase);
        drugStoreDomainOrderAggregateCardTableBase.Columns.Add("cvc", cvcColumnBase);
        var expiry_monthColumnBase =
            new ColumnBase<ColumnMappingBase>("expiry_month", "smallint", drugStoreDomainOrderAggregateCardTableBase);
        drugStoreDomainOrderAggregateCardTableBase.Columns.Add("expiry_month", expiry_monthColumnBase);
        var expiry_yearColumnBase =
            new ColumnBase<ColumnMappingBase>("expiry_year", "integer", drugStoreDomainOrderAggregateCardTableBase);
        drugStoreDomainOrderAggregateCardTableBase.Columns.Add("expiry_year", expiry_yearColumnBase);
        var idColumnBase4 = new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainOrderAggregateCardTableBase);
        drugStoreDomainOrderAggregateCardTableBase.Columns.Add("id", idColumnBase4);
        var nameColumnBase0 = new ColumnBase<ColumnMappingBase>("name", "character varying(50)",
            drugStoreDomainOrderAggregateCardTableBase);
        drugStoreDomainOrderAggregateCardTableBase.Columns.Add("name", nameColumnBase0);
        var numberColumnBase = new ColumnBase<ColumnMappingBase>("number", "character varying(16)",
            drugStoreDomainOrderAggregateCardTableBase);
        ...
        drugStoreDomainOrderAggregateCardTableBase.Columns.Add("update_date", update_dateColumnBase2);
        var versionColumnBase2 =
            new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainOrderAggregateCardTableBase);
        drugStoreDomainOrderAggregateCardTableBase.Columns.Add("version", versionColumnBase2);
        relationalModel.DefaultTables.Add("DrugStore.Domain.OrderAggregate.Card",
            drugStoreDomainOrderAggregateCardTableBase);
        var drugStoreDomainOrderAggregateCardMappingBase =
            new TableMappingBase<ColumnMappingBase>(card, drugStoreDomainOrderAggregateCardTableBase, true);
        drugStoreDomainOrderAggregateCardTableBase.AddTypeMapping(drugStoreDomainOrderAggregateCardMappingBase, false);
        defaultTableMappings5.Add(drugStoreDomainOrderAggregateCardMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase4, card.FindProperty("Id")!,
            drugStoreDomainOrderAggregateCardMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase2,
            card.FindProperty("CreatedDate")!, drugStoreDomainOrderAggregateCardMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)cvcColumnBase, card.FindProperty("Cvc")!,
            drugStoreDomainOrderAggregateCardMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)expiry_monthColumnBase,
            card.FindProperty("ExpiryMonth")!, drugStoreDomainOrderAggregateCardMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)expiry_yearColumnBase,
            card.FindProperty("ExpiryYear")!, drugStoreDomainOrderAggregateCardMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)nameColumnBase0, card.FindProperty("Name")!,
            drugStoreDomainOrderAggregateCardMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)numberColumnBase,
            card.FindProperty("Number")!, drugStoreDomainOrderAggregateCardMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase2,
            card.FindProperty("UpdateDate")!, drugStoreDomainOrderAggregateCardMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase2,
            card.FindProperty("Version")!, drugStoreDomainOrderAggregateCardMappingBase);

        var tableMappings5 = new List<TableMapping>();
        card.SetRuntimeAnnotation("Relational:TableMappings", tableMappings5);
        var cardsTable = new Table("cards", null, relationalModel);
        var idColumn4 = new Column("id", "uuid", cardsTable);
        cardsTable.Columns.Add("id", idColumn4);
        var created_dateColumn2 = new Column("created_date", "timestamp with time zone", cardsTable);
        cardsTable.Columns.Add("created_date", created_dateColumn2);
        ...
        var nameColumn0 = new Column("name", "character varying(50)", cardsTable);
        cardsTable.Columns.Add("name", nameColumn0);
        var numberColumn = new Column("number", "character varying(16)", cardsTable);
        cardsTable.Columns.Add("number", numberColumn);
        var update_dateColumn2 = new Column("update_date", "timestamp with time zone", cardsTable)
        {
            IsNullable = true
        };
        cardsTable.Columns.Add("update_date", update_dateColumn2);
        var versionColumn2 = new Column("version", "uuid", cardsTable);
        cardsTable.Columns.Add("version", versionColumn2);
        var pk_cards = new UniqueConstraint("pk_cards", cardsTable, new[] { idColumn4 });
        ...
        tableMappings5.Add(cardsTableMapping);
        RelationalModel.CreateColumnMapping(idColumn4, card.FindProperty("Id")!, cardsTableMapping);
        RelationalModel.CreateColumnMapping(created_dateColumn2, card.FindProperty("CreatedDate")!, cardsTableMapping);
        ...
        RelationalModel.CreateColumnMapping(nameColumn0, card.FindProperty("Name")!, cardsTableMapping);
        RelationalModel.CreateColumnMapping(numberColumn, card.FindProperty("Number")!, cardsTableMapping);
        RelationalModel.CreateColumnMapping(update_dateColumn2, card.FindProperty("UpdateDate")!, cardsTableMapping);
        RelationalModel.CreateColumnMapping(versionColumn2, card.FindProperty("Version")!, cardsTableMapping);
        ...
        var drugStoreDomainOrderAggregateOrderTableBase =
            new TableBase("DrugStore.Domain.OrderAggregate.Order", null, relationalModel);
        var card_idColumnBase =
            new ColumnBase<ColumnMappingBase>("card_id", "uuid", drugStoreDomainOrderAggregateOrderTableBase)
            {
                IsNullable = true
            };
        drugStoreDomainOrderAggregateOrderTableBase.Columns.Add("card_id", card_idColumnBase);
        var codeColumnBase = new ColumnBase<ColumnMappingBase>("code", "character varying(20)",
        ...
        var created_dateColumnBase3 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone",
            drugStoreDomainOrderAggregateOrderTableBase);
        drugStoreDomainOrderAggregateOrderTableBase.Columns.Add("created_date", created_dateColumnBase3);
        var customer_idColumnBase =
            new ColumnBase<ColumnMappingBase>("customer_id", "uuid", drugStoreDomainOrderAggregateOrderTableBase)
            {
                IsNullable = true
            };
        ...
        drugStoreDomainOrderAggregateOrderTableBase.Columns.Add("id", idColumnBase5);
        ...
        var update_dateColumnBase3 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone",
            drugStoreDomainOrderAggregateOrderTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainOrderAggregateOrderTableBase.Columns.Add("update_date", update_dateColumnBase3);
        var versionColumnBase3 =
            new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainOrderAggregateOrderTableBase);
        drugStoreDomainOrderAggregateOrderTableBase.Columns.Add("version", versionColumnBase3);
        relationalModel.DefaultTables.Add("DrugStore.Domain.OrderAggregate.Order",
            drugStoreDomainOrderAggregateOrderTableBase);
        var drugStoreDomainOrderAggregateOrderMappingBase =
            new TableMappingBase<ColumnMappingBase>(order, drugStoreDomainOrderAggregateOrderTableBase, true);
        drugStoreDomainOrderAggregateOrderTableBase.AddTypeMapping(drugStoreDomainOrderAggregateOrderMappingBase,
            false);
        defaultTableMappings6.Add(drugStoreDomainOrderAggregateOrderMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase5, order.FindProperty("Id")!,
            drugStoreDomainOrderAggregateOrderMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)card_idColumnBase,
            order.FindProperty("CardId")!, drugStoreDomainOrderAggregateOrderMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)codeColumnBase, order.FindProperty("Code")!,
            drugStoreDomainOrderAggregateOrderMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase3,
            order.FindProperty("CreatedDate")!, drugStoreDomainOrderAggregateOrderMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)customer_idColumnBase,
            order.FindProperty("CustomerId")!, drugStoreDomainOrderAggregateOrderMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)payment_methodColumnBase,
            order.FindProperty("PaymentMethod")!, drugStoreDomainOrderAggregateOrderMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)statusColumnBase,
            order.FindProperty("Status")!, drugStoreDomainOrderAggregateOrderMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase3,
            order.FindProperty("UpdateDate")!, drugStoreDomainOrderAggregateOrderMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase3,
            order.FindProperty("Version")!, drugStoreDomainOrderAggregateOrderMappingBase);
        ...
        var idColumn5 = new Column("id", "uuid", ordersTable);
        ordersTable.Columns.Add("id", idColumn5);
        ...
        var created_dateColumn3 = new Column("created_date", "timestamp with time zone", ordersTable);
        ordersTable.Columns.Add("created_date", created_dateColumn3);
        ...
        var update_dateColumn3 = new Column("update_date", "timestamp with time zone", ordersTable)
        {
            IsNullable = true
        };
        ordersTable.Columns.Add("update_date", update_dateColumn3);
        var versionColumn3 = new Column("version", "uuid", ordersTable);
        ordersTable.Columns.Add("version", versionColumn3);
        var pk_orders = new UniqueConstraint("pk_orders", ordersTable, new[] { idColumn5 });
        ...
        RelationalModel.CreateColumnMapping(idColumn5, order.FindProperty("Id")!, ordersTableMapping);
        ...
        RelationalModel.CreateColumnMapping(created_dateColumn3, order.FindProperty("CreatedDate")!,
            ordersTableMapping);
        RelationalModel.CreateColumnMapping(customer_idColumn, order.FindProperty("CustomerId")!, ordersTableMapping);
        RelationalModel.CreateColumnMapping(payment_methodColumn, order.FindProperty("PaymentMethod")!,
            ordersTableMapping);
        RelationalModel.CreateColumnMapping(statusColumn, order.FindProperty("Status")!, ordersTableMapping);
        RelationalModel.CreateColumnMapping(update_dateColumn3, order.FindProperty("UpdateDate")!, ordersTableMapping);
        RelationalModel.CreateColumnMapping(versionColumn3, order.FindProperty("Version")!, ordersTableMapping);
        ...
        orderItem.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings7);
        var drugStoreDomainOrderAggregateOrderItemTableBase =
            new TableBase("DrugStore.Domain.OrderAggregate.OrderItem", null, relationalModel);
        var created_dateColumnBase4 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone",
            drugStoreDomainOrderAggregateOrderItemTableBase);
        drugStoreDomainOrderAggregateOrderItemTableBase.Columns.Add("created_date", created_dateColumnBase4);
        ...
        var update_dateColumnBase4 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone",
            drugStoreDomainOrderAggregateOrderItemTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainOrderAggregateOrderItemTableBase.Columns.Add("update_date", update_dateColumnBase4);
        var versionColumnBase4 =
            new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainOrderAggregateOrderItemTableBase);
        drugStoreDomainOrderAggregateOrderItemTableBase.Columns.Add("version", versionColumnBase4);
        relationalModel.DefaultTables.Add("DrugStore.Domain.OrderAggregate.OrderItem",
            drugStoreDomainOrderAggregateOrderItemTableBase);
        var drugStoreDomainOrderAggregateOrderItemMappingBase =
            new TableMappingBase<ColumnMappingBase>(orderItem, drugStoreDomainOrderAggregateOrderItemTableBase, true);
        drugStoreDomainOrderAggregateOrderItemTableBase.AddTypeMapping(
            drugStoreDomainOrderAggregateOrderItemMappingBase, false);
        defaultTableMappings7.Add(drugStoreDomainOrderAggregateOrderItemMappingBase);
        ...
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase4,
        ...
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase4,
            orderItem.FindProperty("UpdateDate")!, drugStoreDomainOrderAggregateOrderItemMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase4,
            orderItem.FindProperty("Version")!, drugStoreDomainOrderAggregateOrderItemMappingBase);

        var tableMappings7 = new List<TableMapping>();
        orderItem.SetRuntimeAnnotation("Relational:TableMappings", tableMappings7);
        ...
        var created_dateColumn4 = new Column("created_date", "timestamp with time zone", order_detailsTable);
        order_detailsTable.Columns.Add("created_date", created_dateColumn4);
        ...
        var update_dateColumn4 = new Column("update_date", "timestamp with time zone", order_detailsTable)
        {
            IsNullable = true
        };
        order_detailsTable.Columns.Add("update_date", update_dateColumn4);
        var versionColumn4 = new Column("version", "uuid", order_detailsTable);
        order_detailsTable.Columns.Add("version", versionColumn4);
        ...
        tableMappings7.Add(order_detailsTableMapping);
        ...
        RelationalModel.CreateColumnMapping(product_idColumn, orderItem.FindProperty("ProductId")!,
            order_detailsTableMapping);
        RelationalModel.CreateColumnMapping(created_dateColumn4, orderItem.FindProperty("CreatedDate")!,
            order_detailsTableMapping);
        ...
        RelationalModel.CreateColumnMapping(quantityColumn, orderItem.FindProperty("Quantity")!,
            order_detailsTableMapping);
        RelationalModel.CreateColumnMapping(update_dateColumn4, orderItem.FindProperty("UpdateDate")!,
            order_detailsTableMapping);
        RelationalModel.CreateColumnMapping(versionColumn4, orderItem.FindProperty("Version")!,
            order_detailsTableMapping);
        ...
        var drugStoreDomainProductAggregateProductTableBase =
            new TableBase("DrugStore.Domain.ProductAggregate.Product", null, relationalModel);
        var category_idColumnBase1 =
            new ColumnBase<ColumnMappingBase>("category_id", "uuid", drugStoreDomainProductAggregateProductTableBase)
            {
                IsNullable = true
            };
        drugStoreDomainProductAggregateProductTableBase.Columns.Add("category_id", category_idColumnBase1);
        var created_dateColumnBase5 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone",
            drugStoreDomainProductAggregateProductTableBase);
        drugStoreDomainProductAggregateProductTableBase.Columns.Add("created_date", created_dateColumnBase5);
        ...
        var update_dateColumnBase5 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone",
            drugStoreDomainProductAggregateProductTableBase)
        {
            IsNullable = true
        };
        drugStoreDomainProductAggregateProductTableBase.Columns.Add("update_date", update_dateColumnBase5);
        var versionColumnBase5 =
            new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainProductAggregateProductTableBase);
        drugStoreDomainProductAggregateProductTableBase.Columns.Add("version", versionColumnBase5);
        relationalModel.DefaultTables.Add("DrugStore.Domain.ProductAggregate.Product",
            drugStoreDomainProductAggregateProductTableBase);
        var drugStoreDomainProductAggregateProductMappingBase =
            new TableMappingBase<ColumnMappingBase>(product, drugStoreDomainProductAggregateProductTableBase, true);
        drugStoreDomainProductAggregateProductTableBase.AddTypeMapping(
            drugStoreDomainProductAggregateProductMappingBase, false);
        defaultTableMappings8.Add(drugStoreDomainProductAggregateProductMappingBase);
        ...
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase5,
            product.FindProperty("CreatedDate")!, drugStoreDomainProductAggregateProductMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)detailColumnBase1,
            product.FindProperty("Detail")!, drugStoreDomainProductAggregateProductMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)product_codeColumnBase,
            product.FindProperty("ProductCode")!, drugStoreDomainProductAggregateProductMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)quantityColumnBase0,
            product.FindProperty("Quantity")!, drugStoreDomainProductAggregateProductMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)statusColumnBase0,
            product.FindProperty("Status")!, drugStoreDomainProductAggregateProductMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)titleColumnBase2,
            product.FindProperty("Title")!, drugStoreDomainProductAggregateProductMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase5,
            product.FindProperty("UpdateDate")!, drugStoreDomainProductAggregateProductMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase5,
            product.FindProperty("Version")!, drugStoreDomainProductAggregateProductMappingBase);
        ...
        var created_dateColumn5 = new Column("created_date", "timestamp with time zone", productsTable);
        productsTable.Columns.Add("created_date", created_dateColumn5);
        ...
        var update_dateColumn5 = new Column("update_date", "timestamp with time zone", productsTable)
        {
            IsNullable = true
        };
        productsTable.Columns.Add("update_date", update_dateColumn5);
        var versionColumn5 = new Column("version", "uuid", productsTable);
        productsTable.Columns.Add("version", versionColumn5);
        ...
        RelationalModel.CreateColumnMapping(created_dateColumn5, product.FindProperty("CreatedDate")!,
            productsTableMapping);
        RelationalModel.CreateColumnMapping(detailColumn1, product.FindProperty("Detail")!, productsTableMapping);
        RelationalModel.CreateColumnMapping(product_codeColumn, product.FindProperty("ProductCode")!,
            productsTableMapping);
        ...
        RelationalModel.CreateColumnMapping(update_dateColumn5, product.FindProperty("UpdateDate")!,
            productsTableMapping);
        RelationalModel.CreateColumnMapping(versionColumn5, product.FindProperty("Version")!, productsTableMapping);
        ...
        productImage.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings9);
        ...
        var idColumnBase7 = new ColumnBase<ColumnMappingBase>("id", "integer",
            drugStoreDomainProductAggregateValueObjectsProductImageTableBase);
        drugStoreDomainProductAggregateValueObjectsProductImageTableBase.Columns.Add("id", idColumnBase7);
        ...
        defaultTableMappings9.Add(drugStoreDomainProductAggregateValueObjectsProductImageMappingBase);
        ...
        productImage.SetRuntimeAnnotation("Relational:TableMappings", tableMappings9);
        ...
        var titleColumn3 = new Column("title", "character varying(100)", product_imageTable)
        {
            IsNullable = true
        };
        ...
        tableMappings9.Add(product_imageTableMapping);
        ...
        RelationalModel.CreateColumnMapping(image_urlColumn, productImage.FindProperty("ImageUrl")!,
            product_imageTableMapping);
        RelationalModel.CreateColumnMapping(is_mainColumn, productImage.FindProperty("IsMain")!,
            product_imageTableMapping);
        ...
        productPrice.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings10);
        ...
        defaultTableMappings10.Add(drugStoreDomainProductAggregateValueObjectsProductPriceMappingBase);

        var tableMappings10 = new List<TableMapping>();
        productPrice.SetRuntimeAnnotation("Relational:TableMappings", tableMappings10);
        ...
        tableMappings10.Add(productsTableMapping0);
        ...
        RelationalModel.CreateColumnMapping(claim_typeColumn, identityRoleClaim.FindProperty("ClaimType")!,
            aspNetRoleClaimsTableMapping);
        RelationalModel.CreateColumnMapping(claim_valueColumn, identityRoleClaim.FindProperty("ClaimValue")!,
            aspNetRoleClaimsTableMapping);
        ...
        RelationalModel.CreateColumnMapping(claim_typeColumn0, identityUserClaim.FindProperty("ClaimType")!,
            aspNetUserClaimsTableMapping);
        RelationalModel.CreateColumnMapping(claim_valueColumn0, identityUserClaim.FindProperty("ClaimValue")!,
            aspNetUserClaimsTableMapping);
        ...
        var pk_asp_net_user_logins = new UniqueConstraint("pk_asp_net_user_logins", aspNetUserLoginsTable,
        ...
        RelationalModel.CreateColumnMapping(login_providerColumn, identityUserLogin.FindProperty("LoginProvider")!,
            aspNetUserLoginsTableMapping);
        RelationalModel.CreateColumnMapping(provider_keyColumn, identityUserLogin.FindProperty("ProviderKey")!,
            aspNetUserLoginsTableMapping);
        RelationalModel.CreateColumnMapping(provider_display_nameColumn,
            identityUserLogin.FindProperty("ProviderDisplayName")!, aspNetUserLoginsTableMapping);
        ...
        var pk_asp_net_user_roles = new UniqueConstraint("pk_asp_net_user_roles", aspNetUserRolesTable,
        ...
        RelationalModel.CreateColumnMapping(role_idColumn0, identityUserRole.FindProperty("RoleId")!,
        ...
        var nameColumnBase1 = new ColumnBase<ColumnMappingBase>("name", "text",
            microsoftAspNetCoreIdentityIdentityUserTokenDrugStoreDomainIdentityAggregatePrimitivesIdentityIdTableBase);
        microsoftAspNetCoreIdentityIdentityUserTokenDrugStoreDomainIdentityAggregatePrimitivesIdentityIdTableBase
        ...
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)login_providerColumnBase0,
            ...
            microsoftAspNetCoreIdentityIdentityUserTokenDrugStoreDomainIdentityAggregatePrimitivesIdentityIdMappingBase);
        RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)nameColumnBase1,
        ...
        var pk_asp_net_user_tokens = new UniqueConstraint("pk_asp_net_user_tokens", aspNetUserTokensTable,
            new[] { user_idColumn2, login_providerColumn0, nameColumn1 });
        ...
        RelationalModel.CreateColumnMapping(login_providerColumn0, identityUserToken.FindProperty("LoginProvider")!,
            aspNetUserTokensTableMapping);
        RelationalModel.CreateColumnMapping(nameColumn1, identityUserToken.FindProperty("Name")!,
            aspNetUserTokensTableMapping);
        RelationalModel.CreateColumnMapping(user_idColumn2, identityUserToken.FindProperty("UserId")!,
            aspNetUserTokensTableMapping);
        RelationalModel.CreateColumnMapping(valueColumn, identityUserToken.FindProperty("Value")!,
            aspNetUserTokensTableMapping);
        ...
        var fk_asp_net_role_claims_asp_net_roles_role_idFk = RelationalModel.GetForeignKey(this,
            ...
            "DrugStore.Domain.IdentityAggregate.ApplicationRole",
            new[] { "Id" });
        fk_asp_net_role_claims_asp_net_roles_role_id.MappedForeignKeys.Add(
            fk_asp_net_role_claims_asp_net_roles_role_idFk);
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_asp_net_role_claims_asp_net_roles_role_idFk)
            .Add(fk_asp_net_role_claims_asp_net_roles_role_id);
        ...
        var fk_asp_net_user_claims_asp_net_users_user_idFk = RelationalModel.GetForeignKey(this,
            ...
            "DrugStore.Domain.IdentityAggregate.ApplicationUser",
            new[] { "Id" });
        fk_asp_net_user_claims_asp_net_users_user_id.MappedForeignKeys.Add(
            fk_asp_net_user_claims_asp_net_users_user_idFk);
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_asp_net_user_claims_asp_net_users_user_idFk)
            .Add(fk_asp_net_user_claims_asp_net_users_user_id);
        ...
        var fk_asp_net_user_logins_asp_net_users_user_idFk = RelationalModel.GetForeignKey(this,
            ...
            "DrugStore.Domain.IdentityAggregate.ApplicationUser",
            new[] { "Id" });
        fk_asp_net_user_logins_asp_net_users_user_id.MappedForeignKeys.Add(
            fk_asp_net_user_logins_asp_net_users_user_idFk);
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_asp_net_user_logins_asp_net_users_user_idFk)
            .Add(fk_asp_net_user_logins_asp_net_users_user_id);
        ...
        var fk_asp_net_user_roles_asp_net_roles_role_idFk = RelationalModel.GetForeignKey(this,
            ...
            "DrugStore.Domain.IdentityAggregate.ApplicationRole",
            new[] { "Id" });
        fk_asp_net_user_roles_asp_net_roles_role_id.MappedForeignKeys.Add(
            fk_asp_net_user_roles_asp_net_roles_role_idFk);
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_asp_net_user_roles_asp_net_roles_role_idFk)
            .Add(fk_asp_net_user_roles_asp_net_roles_role_id);
        ...
        var fk_asp_net_user_roles_asp_net_users_user_idFk = RelationalModel.GetForeignKey(this,
            ...
            "DrugStore.Domain.IdentityAggregate.ApplicationUser",
            new[] { "Id" });
        fk_asp_net_user_roles_asp_net_users_user_id.MappedForeignKeys.Add(
            fk_asp_net_user_roles_asp_net_users_user_idFk);
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_asp_net_user_roles_asp_net_users_user_idFk)
            .Add(fk_asp_net_user_roles_asp_net_users_user_id);
        ...
        var fk_asp_net_user_tokens_asp_net_users_user_idFk = RelationalModel.GetForeignKey(this,
            ...
            "DrugStore.Domain.IdentityAggregate.ApplicationUser",
            new[] { "Id" });
        fk_asp_net_user_tokens_asp_net_users_user_id.MappedForeignKeys.Add(
            fk_asp_net_user_tokens_asp_net_users_user_idFk);
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_asp_net_user_tokens_asp_net_users_user_idFk)
            .Add(fk_asp_net_user_tokens_asp_net_users_user_id);
        ...
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_news_categories_category_idFk)
            .Add(fk_news_categories_category_id);
        ...
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_order_details_orders_order_idFk)
            .Add(fk_order_details_orders_order_id);
        ...
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_order_details_products_product_idFk)
        ...
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_posts_categories_category_idFk)
            .Add(fk_posts_categories_category_id);
        ...
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_product_image_products_product_idFk)
            .Add(fk_product_image_products_product_id);
        ...
        RelationalModel.GetOrCreateForeignKeyConstraints(fk_products_categories_category_idFk)
            .Add(fk_products_categories_category_id);
