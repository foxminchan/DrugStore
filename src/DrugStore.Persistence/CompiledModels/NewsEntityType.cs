...
internal partial class NewsEntityType
{
    public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
    {
        ...
        createdDate.AddAnnotation("Relational:DefaultValue",
            new DateTime(2024, 3, 3, 5, 45, 27, 806, DateTimeKind.Utc).AddTicks(8079));

        var detail = runtimeEntityType.AddProperty(
            "Detail",
            typeof(string),
            propertyInfo: typeof(News).GetProperty("Detail",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(News).GetField("<Detail>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            maxLength: 500);
        ...
        var image = runtimeEntityType.AddProperty(
            "Image",
            typeof(string),
            propertyInfo: typeof(News).GetProperty("Image",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(News).GetField("<Image>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            nullable: true,
            maxLength: 100);
        ...
        var title = runtimeEntityType.AddProperty(
            "Title",
            typeof(string),
            propertyInfo: typeof(News).GetProperty("Title",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(News).GetField("<Title>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            maxLength: 50);
        ...
        updateDate.AddAnnotation("Relational:DefaultValue",
            new DateTime(2024, 3, 3, 5, 45, 27, 806, DateTimeKind.Utc).AddTicks(9125));
        ...
        RuntimeEntityType principalEntityType)
    {
        ...
        var category = declaringEntityType.AddNavigation("Category",
            ...
            onDependent: true,
            typeof(Category),
            propertyInfo: typeof(News).GetProperty("Category",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(News).GetField("<Category>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
        ...
        var news = principalEntityType.AddNavigation("News",
            ...
            propertyInfo: typeof(Category).GetProperty("News",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Category).GetField("<News>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
