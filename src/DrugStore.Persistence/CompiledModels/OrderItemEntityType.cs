...
internal partial class OrderItemEntityType
{
    public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
    {
        ...
        createdDate.AddAnnotation("Relational:DefaultValue",
            new DateTime(2024, 2, 28, 10, 58, 58, 121, DateTimeKind.Utc).AddTicks(2296));
        ...
        var price = runtimeEntityType.AddProperty(
            "Price",
            typeof(decimal),
            propertyInfo: typeof(OrderItem).GetProperty("Price",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(OrderItem).GetField("<Price>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            sentinel: 0m);
        ...
        var quantity = runtimeEntityType.AddProperty(
            "Quantity",
            typeof(int),
            propertyInfo: typeof(OrderItem).GetProperty("Quantity",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(OrderItem).GetField("<Quantity>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            sentinel: 0);
        ...
        updateDate.AddAnnotation("Relational:DefaultValue",
            new DateTime(2024, 2, 28, 10, 58, 58, 121, DateTimeKind.Utc).AddTicks(3093));
        ...
        RuntimeEntityType principalEntityType)
    {
        ...
        var order = declaringEntityType.AddNavigation("Order",
            ...
            onDependent: true,
            typeof(Order),
            propertyInfo: typeof(OrderItem).GetProperty("Order",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(OrderItem).GetField("<Order>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
        ...
        var orderItems = principalEntityType.AddNavigation("OrderItems",
            ...
            propertyInfo: typeof(Order).GetProperty("OrderItems",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Order).GetField("<OrderItems>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
        ...
        RuntimeEntityType principalEntityType)
    {
        ...
        var product = declaringEntityType.AddNavigation("Product",
            ...
            onDependent: true,
            typeof(Product),
            propertyInfo: typeof(OrderItem).GetProperty("Product",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(OrderItem).GetField("<Product>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
        ...
        var orderItems = principalEntityType.AddNavigation("OrderItems",
            ...
            onDependent: false,
            typeof(ICollection<OrderItem>),
            propertyInfo: typeof(Product).GetProperty("OrderItems",
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Product).GetField("<OrderItems>k__BackingField",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
