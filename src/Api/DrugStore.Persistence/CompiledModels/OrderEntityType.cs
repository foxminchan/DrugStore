...
namespace DrugStore.Persistence.CompiledModels
{
    internal partial class OrderEntityType
    {
        ...
        createdDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 2, 28, 10, 58, 58, 120, DateTimeKind.Utc).AddTicks(7401));
        ...
        updateDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 2, 28, 10, 58, 58, 120, DateTimeKind.Utc).AddTicks(8409));
