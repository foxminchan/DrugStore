...
namespace DrugStore.Persistence.CompileModels
{
        ...
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            alt.TypeMapping = NpgsqlStringTypeMapping.Default.Clone(
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    ...
                    size: 100));
            alt.TypeMapping = ((NpgsqlStringTypeMapping)alt.TypeMapping).Clone(npgsqlDbType: NpgsqlTypes.NpgsqlDbType.Varchar);
    ...
    var isMain = runtimeEntityType.AddProperty(
        "IsMain",
        typeof(bool),
        propertyInfo: typeof(ProductImage).GetProperty("IsMain", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
        fieldInfo: typeof(ProductImage).GetField("<IsMain>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
        sentinel: false);
...
public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
{
    ...
    var images = principalEntityType.AddNavigation("Images",
        ...
        propertyInfo: typeof(Product).GetProperty("Images", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
        fieldInfo: typeof(Product).GetField("<Images>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
