...
namespace DrugStore.Persistence.CompileModels
{
    internal partial class ProductEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            createdDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 2, 24, 15, 4, 3, 115, DateTimeKind.Utc).AddTicks(5572));
        ...
        price.TypeMapping = NpgsqlJsonTypeMapping.Default.Clone(
            comparer: new ValueComparer<ProductPrice>(
                (ProductPrice v1, ProductPrice v2) => object.Equals(v1, v2),
...
updateDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 2, 24, 15, 4, 3, 115, DateTimeKind.Utc).AddTicks(5872));
