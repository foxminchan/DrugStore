...
namespace DrugStore.Persistence.CompileModels
{
    internal partial class CategoryEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            createdDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 2, 24, 15, 4, 3, 114, DateTimeKind.Utc).AddTicks(3879));

            var link = runtimeEntityType.AddProperty(
                "Link",
                typeof(string),
                propertyInfo: typeof(Category).GetProperty("Link", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Category).GetField("<Link>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true,
                maxLength: 100);
            link.TypeMapping = NpgsqlStringTypeMapping.Default.Clone(
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    ...
                    size: 100));
            link.TypeMapping = ((NpgsqlStringTypeMapping)link.TypeMapping).Clone(npgsqlDbType: NpgsqlTypes.NpgsqlDbType.Varchar);
        ...
        var title = runtimeEntityType.AddProperty(
            "Title",
            typeof(string),
            propertyInfo: typeof(Category).GetProperty("Title", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Category).GetField("<Title>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            maxLength: 50);
    ...
    updateDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 2, 24, 15, 4, 3, 114, DateTimeKind.Utc).AddTicks(4159));
