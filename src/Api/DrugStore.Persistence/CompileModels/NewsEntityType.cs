    ...
    internal partial class NewsEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var categoryId = runtimeEntityType.AddProperty(
                "CategoryId",
                typeof(Guid?),
                propertyInfo: typeof(News).GetProperty("CategoryId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(News).GetField("<CategoryId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            ...
            createdDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 2, 24, 15, 4, 3, 114, DateTimeKind.Utc).AddTicks(5476));

            var detail = runtimeEntityType.AddProperty(
                "Detail",
                typeof(string),
                propertyInfo: typeof(News).GetProperty("Detail", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(News).GetField("<Detail>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                maxLength: 500);
        ...
        var image = runtimeEntityType.AddProperty(
            "Image",
            typeof(string),
            propertyInfo: typeof(News).GetProperty("Image", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(News).GetField("<Image>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            nullable: true,
            maxLength: 100);
...
updateDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 2, 24, 15, 4, 3, 114, DateTimeKind.Utc).AddTicks(5695));
...
key.AddAnnotation("Relational:Name", "pk_news");

var index = runtimeEntityType.AddIndex(
    new[] { categoryId });
index.AddAnnotation("Relational:Name", "ix_news_category_id");
...
public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
{
    ...
    var category = declaringEntityType.AddNavigation("Category",
        ...
        onDependent: true,
        typeof(Category),
        propertyInfo: typeof(News).GetProperty("Category", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
        fieldInfo: typeof(News).GetField("<Category>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

    var news = principalEntityType.AddNavigation("News",
        runtimeForeignKey,
        onDependent: false,
        typeof(ICollection<News>),
        propertyInfo: typeof(Category).GetProperty("News", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
        fieldInfo: typeof(Category).GetField("<News>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

    runtimeForeignKey.AddAnnotation("Relational:Name", "fk_news_categories_category_id");
