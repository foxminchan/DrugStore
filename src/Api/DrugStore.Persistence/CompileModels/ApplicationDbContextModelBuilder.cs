...
namespace DrugStore.Persistence.CompileModels
{
    public partial class ApplicationDbContextModel
    {
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var category = FindEntityType("DrugStore.Domain.Category.Category")!;

            var defaultTableMappings = new List<TableMappingBase<ColumnMappingBase>>();
            category.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings);
            var drugStoreDomainCategoryCategoryTableBase = new TableBase("DrugStore.Domain.Category.Category", null, relationalModel);
            var created_dateColumnBase = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone", drugStoreDomainCategoryCategoryTableBase);
            drugStoreDomainCategoryCategoryTableBase.Columns.Add("created_date", created_dateColumnBase);
            var idColumnBase = new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainCategoryCategoryTableBase);
            drugStoreDomainCategoryCategoryTableBase.Columns.Add("id", idColumnBase);
            var linkColumnBase = new ColumnBase<ColumnMappingBase>("link", "character varying(100)", drugStoreDomainCategoryCategoryTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainCategoryCategoryTableBase.Columns.Add("link", linkColumnBase);
            var titleColumnBase = new ColumnBase<ColumnMappingBase>("title", "character varying(50)", drugStoreDomainCategoryCategoryTableBase);
            drugStoreDomainCategoryCategoryTableBase.Columns.Add("title", titleColumnBase);
            var update_dateColumnBase = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone", drugStoreDomainCategoryCategoryTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainCategoryCategoryTableBase.Columns.Add("update_date", update_dateColumnBase);
            var versionColumnBase = new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainCategoryCategoryTableBase);
            drugStoreDomainCategoryCategoryTableBase.Columns.Add("version", versionColumnBase);
            relationalModel.DefaultTables.Add("DrugStore.Domain.Category.Category", drugStoreDomainCategoryCategoryTableBase);
            var drugStoreDomainCategoryCategoryMappingBase = new TableMappingBase<ColumnMappingBase>(category, drugStoreDomainCategoryCategoryTableBase, true);
            drugStoreDomainCategoryCategoryTableBase.AddTypeMapping(drugStoreDomainCategoryCategoryMappingBase, false);
            defaultTableMappings.Add(drugStoreDomainCategoryCategoryMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase, category.FindProperty("Id")!, drugStoreDomainCategoryCategoryMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase, category.FindProperty("CreatedDate")!, drugStoreDomainCategoryCategoryMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)linkColumnBase, category.FindProperty("Link")!, drugStoreDomainCategoryCategoryMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)titleColumnBase, category.FindProperty("Title")!, drugStoreDomainCategoryCategoryMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase, category.FindProperty("UpdateDate")!, drugStoreDomainCategoryCategoryMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase, category.FindProperty("Version")!, drugStoreDomainCategoryCategoryMappingBase);
            ...
            var pk_categoriesUc = RelationalModel.GetKey(this,
                "DrugStore.Domain.Category.Category",
                new[] { "Id" });
            ...
            var applicationRole = FindEntityType("DrugStore.Domain.Identity.ApplicationRole")!;

            var defaultTableMappings0 = new List<TableMappingBase<ColumnMappingBase>>();
            applicationRole.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings0);
            var drugStoreDomainIdentityApplicationRoleTableBase = new TableBase("DrugStore.Domain.Identity.ApplicationRole", null, relationalModel);
            var concurrency_stampColumnBase = new ColumnBase<ColumnMappingBase>("concurrency_stamp", "text", drugStoreDomainIdentityApplicationRoleTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationRoleTableBase.Columns.Add("concurrency_stamp", concurrency_stampColumnBase);
            var idColumnBase0 = new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainIdentityApplicationRoleTableBase);
            drugStoreDomainIdentityApplicationRoleTableBase.Columns.Add("id", idColumnBase0);
            var nameColumnBase = new ColumnBase<ColumnMappingBase>("name", "character varying(256)", drugStoreDomainIdentityApplicationRoleTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationRoleTableBase.Columns.Add("name", nameColumnBase);
            var normalized_nameColumnBase = new ColumnBase<ColumnMappingBase>("normalized_name", "character varying(256)", drugStoreDomainIdentityApplicationRoleTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationRoleTableBase.Columns.Add("normalized_name", normalized_nameColumnBase);
            relationalModel.DefaultTables.Add("DrugStore.Domain.Identity.ApplicationRole", drugStoreDomainIdentityApplicationRoleTableBase);
            var drugStoreDomainIdentityApplicationRoleMappingBase = new TableMappingBase<ColumnMappingBase>(applicationRole, drugStoreDomainIdentityApplicationRoleTableBase, true);
            drugStoreDomainIdentityApplicationRoleTableBase.AddTypeMapping(drugStoreDomainIdentityApplicationRoleMappingBase, false);
            defaultTableMappings0.Add(drugStoreDomainIdentityApplicationRoleMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase0, applicationRole.FindProperty("Id")!, drugStoreDomainIdentityApplicationRoleMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)concurrency_stampColumnBase, applicationRole.FindProperty("ConcurrencyStamp")!, drugStoreDomainIdentityApplicationRoleMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)nameColumnBase, applicationRole.FindProperty("Name")!, drugStoreDomainIdentityApplicationRoleMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)normalized_nameColumnBase, applicationRole.FindProperty("NormalizedName")!, drugStoreDomainIdentityApplicationRoleMappingBase);
            ...
            var pk_asp_net_rolesUc = RelationalModel.GetKey(this,
                "DrugStore.Domain.Identity.ApplicationRole",
                new[] { "Id" });
            ...
            var applicationUser = FindEntityType("DrugStore.Domain.Identity.ApplicationUser")!;

            var defaultTableMappings1 = new List<TableMappingBase<ColumnMappingBase>>();
            applicationUser.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings1);
            var drugStoreDomainIdentityApplicationUserTableBase = new TableBase("DrugStore.Domain.Identity.ApplicationUser", null, relationalModel);
            var access_failed_countColumnBase = new ColumnBase<ColumnMappingBase>("access_failed_count", "integer", drugStoreDomainIdentityApplicationUserTableBase);
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("access_failed_count", access_failed_countColumnBase);
            var addressColumnBase = new ColumnBase<ColumnMappingBase>("address", "jsonb", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("address", addressColumnBase);
            var concurrency_stampColumnBase0 = new ColumnBase<ColumnMappingBase>("concurrency_stamp", "text", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("concurrency_stamp", concurrency_stampColumnBase0);
            var emailColumnBase = new ColumnBase<ColumnMappingBase>("email", "character varying(256)", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("email", emailColumnBase);
            var email_confirmedColumnBase = new ColumnBase<ColumnMappingBase>("email_confirmed", "boolean", drugStoreDomainIdentityApplicationUserTableBase);
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("email_confirmed", email_confirmedColumnBase);
            var full_nameColumnBase = new ColumnBase<ColumnMappingBase>("full_name", "character varying(50)", drugStoreDomainIdentityApplicationUserTableBase);
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("full_name", full_nameColumnBase);
            var idColumnBase1 = new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainIdentityApplicationUserTableBase);
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("id", idColumnBase1);
            var lockout_enabledColumnBase = new ColumnBase<ColumnMappingBase>("lockout_enabled", "boolean", drugStoreDomainIdentityApplicationUserTableBase);
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("lockout_enabled", lockout_enabledColumnBase);
            var lockout_endColumnBase = new ColumnBase<ColumnMappingBase>("lockout_end", "timestamp with time zone", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("lockout_end", lockout_endColumnBase);
            var normalized_emailColumnBase = new ColumnBase<ColumnMappingBase>("normalized_email", "character varying(256)", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("normalized_email", normalized_emailColumnBase);
            var normalized_user_nameColumnBase = new ColumnBase<ColumnMappingBase>("normalized_user_name", "character varying(256)", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("normalized_user_name", normalized_user_nameColumnBase);
            var password_hashColumnBase = new ColumnBase<ColumnMappingBase>("password_hash", "text", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("password_hash", password_hashColumnBase);
            var phoneColumnBase = new ColumnBase<ColumnMappingBase>("phone", "character varying(10)", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("phone", phoneColumnBase);
            var phone_numberColumnBase = new ColumnBase<ColumnMappingBase>("phone_number", "text", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("phone_number", phone_numberColumnBase);
            var phone_number_confirmedColumnBase = new ColumnBase<ColumnMappingBase>("phone_number_confirmed", "boolean", drugStoreDomainIdentityApplicationUserTableBase);
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("phone_number_confirmed", phone_number_confirmedColumnBase);
            var security_stampColumnBase = new ColumnBase<ColumnMappingBase>("security_stamp", "text", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("security_stamp", security_stampColumnBase);
            var two_factor_enabledColumnBase = new ColumnBase<ColumnMappingBase>("two_factor_enabled", "boolean", drugStoreDomainIdentityApplicationUserTableBase);
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("two_factor_enabled", two_factor_enabledColumnBase);
            var user_nameColumnBase = new ColumnBase<ColumnMappingBase>("user_name", "character varying(256)", drugStoreDomainIdentityApplicationUserTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainIdentityApplicationUserTableBase.Columns.Add("user_name", user_nameColumnBase);
            relationalModel.DefaultTables.Add("DrugStore.Domain.Identity.ApplicationUser", drugStoreDomainIdentityApplicationUserTableBase);
            var drugStoreDomainIdentityApplicationUserMappingBase = new TableMappingBase<ColumnMappingBase>(applicationUser, drugStoreDomainIdentityApplicationUserTableBase, true);
            drugStoreDomainIdentityApplicationUserTableBase.AddTypeMapping(drugStoreDomainIdentityApplicationUserMappingBase, false);
            defaultTableMappings1.Add(drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase1, applicationUser.FindProperty("Id")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)access_failed_countColumnBase, applicationUser.FindProperty("AccessFailedCount")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)addressColumnBase, applicationUser.FindProperty("Address")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)concurrency_stampColumnBase0, applicationUser.FindProperty("ConcurrencyStamp")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)emailColumnBase, applicationUser.FindProperty("Email")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)email_confirmedColumnBase, applicationUser.FindProperty("EmailConfirmed")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)full_nameColumnBase, applicationUser.FindProperty("FullName")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)lockout_enabledColumnBase, applicationUser.FindProperty("LockoutEnabled")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)lockout_endColumnBase, applicationUser.FindProperty("LockoutEnd")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)normalized_emailColumnBase, applicationUser.FindProperty("NormalizedEmail")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)normalized_user_nameColumnBase, applicationUser.FindProperty("NormalizedUserName")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)password_hashColumnBase, applicationUser.FindProperty("PasswordHash")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)phoneColumnBase, applicationUser.FindProperty("Phone")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)phone_numberColumnBase, applicationUser.FindProperty("PhoneNumber")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)phone_number_confirmedColumnBase, applicationUser.FindProperty("PhoneNumberConfirmed")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)security_stampColumnBase, applicationUser.FindProperty("SecurityStamp")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)two_factor_enabledColumnBase, applicationUser.FindProperty("TwoFactorEnabled")!, drugStoreDomainIdentityApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)user_nameColumnBase, applicationUser.FindProperty("UserName")!, drugStoreDomainIdentityApplicationUserMappingBase);
            ...
            var phoneColumn = new Column("phone", "character varying(10)", aspNetUsersTable)
            {
                IsNullable = true
            };
            aspNetUsersTable.Columns.Add("phone", phoneColumn);
            ...
            var pk_asp_net_usersUc = RelationalModel.GetKey(this,
                "DrugStore.Domain.Identity.ApplicationUser",
                new[] { "Id" });
            ...
            RelationalModel.CreateColumnMapping(phoneColumn, applicationUser.FindProperty("Phone")!, aspNetUsersTableMapping);
            ...
            var news = FindEntityType("DrugStore.Domain.News.News")!;

            var defaultTableMappings2 = new List<TableMappingBase<ColumnMappingBase>>();
            news.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings2);
            var drugStoreDomainNewsNewsTableBase = new TableBase("DrugStore.Domain.News.News", null, relationalModel);
            var category_idColumnBase = new ColumnBase<ColumnMappingBase>("category_id", "uuid", drugStoreDomainNewsNewsTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainNewsNewsTableBase.Columns.Add("category_id", category_idColumnBase);
            var created_dateColumnBase0 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone", drugStoreDomainNewsNewsTableBase);
            drugStoreDomainNewsNewsTableBase.Columns.Add("created_date", created_dateColumnBase0);
            var detailColumnBase = new ColumnBase<ColumnMappingBase>("detail", "character varying(500)", drugStoreDomainNewsNewsTableBase);
            drugStoreDomainNewsNewsTableBase.Columns.Add("detail", detailColumnBase);
            var idColumnBase2 = new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainNewsNewsTableBase);
            drugStoreDomainNewsNewsTableBase.Columns.Add("id", idColumnBase2);
            var imageColumnBase = new ColumnBase<ColumnMappingBase>("image", "character varying(100)", drugStoreDomainNewsNewsTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainNewsNewsTableBase.Columns.Add("image", imageColumnBase);
            var titleColumnBase0 = new ColumnBase<ColumnMappingBase>("title", "character varying(50)", drugStoreDomainNewsNewsTableBase);
            drugStoreDomainNewsNewsTableBase.Columns.Add("title", titleColumnBase0);
            var update_dateColumnBase0 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone", drugStoreDomainNewsNewsTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainNewsNewsTableBase.Columns.Add("update_date", update_dateColumnBase0);
            var versionColumnBase0 = new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainNewsNewsTableBase);
            drugStoreDomainNewsNewsTableBase.Columns.Add("version", versionColumnBase0);
            relationalModel.DefaultTables.Add("DrugStore.Domain.News.News", drugStoreDomainNewsNewsTableBase);
            var drugStoreDomainNewsNewsMappingBase = new TableMappingBase<ColumnMappingBase>(news, drugStoreDomainNewsNewsTableBase, true);
            drugStoreDomainNewsNewsTableBase.AddTypeMapping(drugStoreDomainNewsNewsMappingBase, false);
            defaultTableMappings2.Add(drugStoreDomainNewsNewsMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase2, news.FindProperty("Id")!, drugStoreDomainNewsNewsMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)category_idColumnBase, news.FindProperty("CategoryId")!, drugStoreDomainNewsNewsMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase0, news.FindProperty("CreatedDate")!, drugStoreDomainNewsNewsMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)detailColumnBase, news.FindProperty("Detail")!, drugStoreDomainNewsNewsMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)imageColumnBase, news.FindProperty("Image")!, drugStoreDomainNewsNewsMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)titleColumnBase0, news.FindProperty("Title")!, drugStoreDomainNewsNewsMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase0, news.FindProperty("UpdateDate")!, drugStoreDomainNewsNewsMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase0, news.FindProperty("Version")!, drugStoreDomainNewsNewsMappingBase);

            var tableMappings2 = new List<TableMapping>();
            news.SetRuntimeAnnotation("Relational:TableMappings", tableMappings2);
            var newsTable = new Table("news", null, relationalModel);
            var idColumn2 = new Column("id", "uuid", newsTable);
            newsTable.Columns.Add("id", idColumn2);
            ...
            var pk_news = new UniqueConstraint("pk_news", newsTable, new[] { idColumn2 });
            newsTable.PrimaryKey = pk_news;
            var pk_newsUc = RelationalModel.GetKey(this,
                "DrugStore.Domain.News.News",
                new[] { "Id" });
            ...
            tableMappings2.Add(newsTableMapping);
            RelationalModel.CreateColumnMapping(idColumn2, news.FindProperty("Id")!, newsTableMapping);
            ...
            var order = FindEntityType("DrugStore.Domain.Order.Order")!;

            var defaultTableMappings3 = new List<TableMappingBase<ColumnMappingBase>>();
            order.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings3);
            var drugStoreDomainOrderOrderTableBase = new TableBase("DrugStore.Domain.Order.Order", null, relationalModel);
            var codeColumnBase = new ColumnBase<ColumnMappingBase>("code", "character varying(20)", drugStoreDomainOrderOrderTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainOrderOrderTableBase.Columns.Add("code", codeColumnBase);
            var created_dateColumnBase1 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone", drugStoreDomainOrderOrderTableBase);
            drugStoreDomainOrderOrderTableBase.Columns.Add("created_date", created_dateColumnBase1);
            var customer_idColumnBase = new ColumnBase<ColumnMappingBase>("customer_id", "uuid", drugStoreDomainOrderOrderTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainOrderOrderTableBase.Columns.Add("customer_id", customer_idColumnBase);
            var idColumnBase3 = new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainOrderOrderTableBase);
            drugStoreDomainOrderOrderTableBase.Columns.Add("id", idColumnBase3);
            var payment_methodColumnBase = new ColumnBase<ColumnMappingBase>("payment_method", "integer", drugStoreDomainOrderOrderTableBase);
            drugStoreDomainOrderOrderTableBase.Columns.Add("payment_method", payment_methodColumnBase);
            var statusColumnBase = new ColumnBase<ColumnMappingBase>("status", "integer", drugStoreDomainOrderOrderTableBase);
            drugStoreDomainOrderOrderTableBase.Columns.Add("status", statusColumnBase);
            var update_dateColumnBase1 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone", drugStoreDomainOrderOrderTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainOrderOrderTableBase.Columns.Add("update_date", update_dateColumnBase1);
            var versionColumnBase1 = new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainOrderOrderTableBase);
            drugStoreDomainOrderOrderTableBase.Columns.Add("version", versionColumnBase1);
            relationalModel.DefaultTables.Add("DrugStore.Domain.Order.Order", drugStoreDomainOrderOrderTableBase);
            var drugStoreDomainOrderOrderMappingBase = new TableMappingBase<ColumnMappingBase>(order, drugStoreDomainOrderOrderTableBase, true);
            drugStoreDomainOrderOrderTableBase.AddTypeMapping(drugStoreDomainOrderOrderMappingBase, false);
            defaultTableMappings3.Add(drugStoreDomainOrderOrderMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase3, order.FindProperty("Id")!, drugStoreDomainOrderOrderMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)codeColumnBase, order.FindProperty("Code")!, drugStoreDomainOrderOrderMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase1, order.FindProperty("CreatedDate")!, drugStoreDomainOrderOrderMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)customer_idColumnBase, order.FindProperty("CustomerId")!, drugStoreDomainOrderOrderMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)payment_methodColumnBase, order.FindProperty("PaymentMethod")!, drugStoreDomainOrderOrderMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)statusColumnBase, order.FindProperty("Status")!, drugStoreDomainOrderOrderMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase1, order.FindProperty("UpdateDate")!, drugStoreDomainOrderOrderMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase1, order.FindProperty("Version")!, drugStoreDomainOrderOrderMappingBase);
            ...
            tableMappings3.Add(ordersTableMapping);
            ...
            var orderItem = FindEntityType("DrugStore.Domain.Order.OrderItem")!;
            ...
            var drugStoreDomainOrderOrderItemTableBase = new TableBase("DrugStore.Domain.Order.OrderItem", null, relationalModel);
            var created_dateColumnBase2 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone", drugStoreDomainOrderOrderItemTableBase);
            drugStoreDomainOrderOrderItemTableBase.Columns.Add("created_date", created_dateColumnBase2);
            var idColumnBase4 = new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainOrderOrderItemTableBase);
            drugStoreDomainOrderOrderItemTableBase.Columns.Add("id", idColumnBase4);
            var order_idColumnBase = new ColumnBase<ColumnMappingBase>("order_id", "uuid", drugStoreDomainOrderOrderItemTableBase);
            drugStoreDomainOrderOrderItemTableBase.Columns.Add("order_id", order_idColumnBase);
            var priceColumnBase = new ColumnBase<ColumnMappingBase>("price", "numeric(18,2)", drugStoreDomainOrderOrderItemTableBase);
            drugStoreDomainOrderOrderItemTableBase.Columns.Add("price", priceColumnBase);
            var product_idColumnBase = new ColumnBase<ColumnMappingBase>("product_id", "uuid", drugStoreDomainOrderOrderItemTableBase);
            drugStoreDomainOrderOrderItemTableBase.Columns.Add("product_id", product_idColumnBase);
            var quantityColumnBase = new ColumnBase<ColumnMappingBase>("quantity", "integer", drugStoreDomainOrderOrderItemTableBase);
            drugStoreDomainOrderOrderItemTableBase.Columns.Add("quantity", quantityColumnBase);
            var update_dateColumnBase2 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone", drugStoreDomainOrderOrderItemTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainOrderOrderItemTableBase.Columns.Add("update_date", update_dateColumnBase2);
            var versionColumnBase2 = new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainOrderOrderItemTableBase);
            drugStoreDomainOrderOrderItemTableBase.Columns.Add("version", versionColumnBase2);
            relationalModel.DefaultTables.Add("DrugStore.Domain.Order.OrderItem", drugStoreDomainOrderOrderItemTableBase);
            var drugStoreDomainOrderOrderItemMappingBase = new TableMappingBase<ColumnMappingBase>(orderItem, drugStoreDomainOrderOrderItemTableBase, true);
            drugStoreDomainOrderOrderItemTableBase.AddTypeMapping(drugStoreDomainOrderOrderItemMappingBase, false);
            defaultTableMappings4.Add(drugStoreDomainOrderOrderItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase4, orderItem.FindProperty("Id")!, drugStoreDomainOrderOrderItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase2, orderItem.FindProperty("CreatedDate")!, drugStoreDomainOrderOrderItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)order_idColumnBase, orderItem.FindProperty("OrderId")!, drugStoreDomainOrderOrderItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)priceColumnBase, orderItem.FindProperty("Price")!, drugStoreDomainOrderOrderItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)product_idColumnBase, orderItem.FindProperty("ProductId")!, drugStoreDomainOrderOrderItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)quantityColumnBase, orderItem.FindProperty("Quantity")!, drugStoreDomainOrderOrderItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase2, orderItem.FindProperty("UpdateDate")!, drugStoreDomainOrderOrderItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase2, orderItem.FindProperty("Version")!, drugStoreDomainOrderOrderItemMappingBase);
            ...
            var idColumn4 = new Column("id", "uuid", order_detailsTable);
            order_detailsTable.Columns.Add("id", idColumn4);
            ...
            var pk_order_details = new UniqueConstraint("pk_order_details", order_detailsTable, new[] { idColumn4 });
            ...
            tableMappings4.Add(order_detailsTableMapping);
            RelationalModel.CreateColumnMapping(idColumn4, orderItem.FindProperty("Id")!, order_detailsTableMapping);
            ...
            var post = FindEntityType("DrugStore.Domain.Post.Post")!;

            var defaultTableMappings5 = new List<TableMappingBase<ColumnMappingBase>>();
            post.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings5);
            var drugStoreDomainPostPostTableBase = new TableBase("DrugStore.Domain.Post.Post", null, relationalModel);
            var category_idColumnBase0 = new ColumnBase<ColumnMappingBase>("category_id", "uuid", drugStoreDomainPostPostTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainPostPostTableBase.Columns.Add("category_id", category_idColumnBase0);
            var created_dateColumnBase3 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone", drugStoreDomainPostPostTableBase);
            drugStoreDomainPostPostTableBase.Columns.Add("created_date", created_dateColumnBase3);
            var detailColumnBase0 = new ColumnBase<ColumnMappingBase>("detail", "character varying(500)", drugStoreDomainPostPostTableBase);
            drugStoreDomainPostPostTableBase.Columns.Add("detail", detailColumnBase0);
            var idColumnBase5 = new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainPostPostTableBase);
            drugStoreDomainPostPostTableBase.Columns.Add("id", idColumnBase5);
            var imageColumnBase0 = new ColumnBase<ColumnMappingBase>("image", "character varying(100)", drugStoreDomainPostPostTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainPostPostTableBase.Columns.Add("image", imageColumnBase0);
            var titleColumnBase1 = new ColumnBase<ColumnMappingBase>("title", "character varying(50)", drugStoreDomainPostPostTableBase);
            drugStoreDomainPostPostTableBase.Columns.Add("title", titleColumnBase1);
            var update_dateColumnBase3 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone", drugStoreDomainPostPostTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainPostPostTableBase.Columns.Add("update_date", update_dateColumnBase3);
            var versionColumnBase3 = new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainPostPostTableBase);
            drugStoreDomainPostPostTableBase.Columns.Add("version", versionColumnBase3);
            relationalModel.DefaultTables.Add("DrugStore.Domain.Post.Post", drugStoreDomainPostPostTableBase);
            var drugStoreDomainPostPostMappingBase = new TableMappingBase<ColumnMappingBase>(post, drugStoreDomainPostPostTableBase, true);
            drugStoreDomainPostPostTableBase.AddTypeMapping(drugStoreDomainPostPostMappingBase, false);
            defaultTableMappings5.Add(drugStoreDomainPostPostMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase5, post.FindProperty("Id")!, drugStoreDomainPostPostMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)category_idColumnBase0, post.FindProperty("CategoryId")!, drugStoreDomainPostPostMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase3, post.FindProperty("CreatedDate")!, drugStoreDomainPostPostMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)detailColumnBase0, post.FindProperty("Detail")!, drugStoreDomainPostPostMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)imageColumnBase0, post.FindProperty("Image")!, drugStoreDomainPostPostMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)titleColumnBase1, post.FindProperty("Title")!, drugStoreDomainPostPostMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase3, post.FindProperty("UpdateDate")!, drugStoreDomainPostPostMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase3, post.FindProperty("Version")!, drugStoreDomainPostPostMappingBase);

            var tableMappings5 = new List<TableMapping>();
            post.SetRuntimeAnnotation("Relational:TableMappings", tableMappings5);
            var postsTable = new Table("posts", null, relationalModel);
            var idColumn5 = new Column("id", "uuid", postsTable);
            postsTable.Columns.Add("id", idColumn5);
            var category_idColumn0 = new Column("category_id", "uuid", postsTable)
            {
                IsNullable = true
            };
            postsTable.Columns.Add("category_id", category_idColumn0);
            var created_dateColumn3 = new Column("created_date", "timestamp with time zone", postsTable);
            postsTable.Columns.Add("created_date", created_dateColumn3);
            ...
            var update_dateColumn3 = new Column("update_date", "timestamp with time zone", postsTable)
            {
                IsNullable = true
            };
            postsTable.Columns.Add("update_date", update_dateColumn3);
            var versionColumn3 = new Column("version", "uuid", postsTable);
            postsTable.Columns.Add("version", versionColumn3);
            var pk_posts = new UniqueConstraint("pk_posts", postsTable, new[] { idColumn5 });
            postsTable.PrimaryKey = pk_posts;
            var pk_postsUc = RelationalModel.GetKey(this,
                "DrugStore.Domain.Post.Post",
                new[] { "Id" });
            ...
            tableMappings5.Add(postsTableMapping);
            RelationalModel.CreateColumnMapping(idColumn5, post.FindProperty("Id")!, postsTableMapping);
            RelationalModel.CreateColumnMapping(category_idColumn0, post.FindProperty("CategoryId")!, postsTableMapping);
            RelationalModel.CreateColumnMapping(created_dateColumn3, post.FindProperty("CreatedDate")!, postsTableMapping);
            ...
            RelationalModel.CreateColumnMapping(update_dateColumn3, post.FindProperty("UpdateDate")!, postsTableMapping);
            RelationalModel.CreateColumnMapping(versionColumn3, post.FindProperty("Version")!, postsTableMapping);

            var product = FindEntityType("DrugStore.Domain.Product.Product")!;
            ...
            var drugStoreDomainProductProductTableBase = new TableBase("DrugStore.Domain.Product.Product", null, relationalModel);
            var category_idColumnBase1 = new ColumnBase<ColumnMappingBase>("category_id", "uuid", drugStoreDomainProductProductTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainProductProductTableBase.Columns.Add("category_id", category_idColumnBase1);
            var created_dateColumnBase4 = new ColumnBase<ColumnMappingBase>("created_date", "timestamp with time zone", drugStoreDomainProductProductTableBase);
            drugStoreDomainProductProductTableBase.Columns.Add("created_date", created_dateColumnBase4);
            var detailColumnBase1 = new ColumnBase<ColumnMappingBase>("detail", "character varying(500)", drugStoreDomainProductProductTableBase);
            drugStoreDomainProductProductTableBase.Columns.Add("detail", detailColumnBase1);
            var idColumnBase6 = new ColumnBase<ColumnMappingBase>("id", "uuid", drugStoreDomainProductProductTableBase);
            drugStoreDomainProductProductTableBase.Columns.Add("id", idColumnBase6);
            var priceColumnBase0 = new ColumnBase<ColumnMappingBase>("price", "jsonb", drugStoreDomainProductProductTableBase);
            drugStoreDomainProductProductTableBase.Columns.Add("price", priceColumnBase0);
            var product_codeColumnBase = new ColumnBase<ColumnMappingBase>("product_code", "character varying(20)", drugStoreDomainProductProductTableBase);
            drugStoreDomainProductProductTableBase.Columns.Add("product_code", product_codeColumnBase);
            var quantityColumnBase0 = new ColumnBase<ColumnMappingBase>("quantity", "integer", drugStoreDomainProductProductTableBase);
            drugStoreDomainProductProductTableBase.Columns.Add("quantity", quantityColumnBase0);
            var statusColumnBase0 = new ColumnBase<ColumnMappingBase>("status", "integer", drugStoreDomainProductProductTableBase);
            drugStoreDomainProductProductTableBase.Columns.Add("status", statusColumnBase0);
            var titleColumnBase2 = new ColumnBase<ColumnMappingBase>("title", "character varying(100)", drugStoreDomainProductProductTableBase);
            drugStoreDomainProductProductTableBase.Columns.Add("title", titleColumnBase2);
            var update_dateColumnBase4 = new ColumnBase<ColumnMappingBase>("update_date", "timestamp with time zone", drugStoreDomainProductProductTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainProductProductTableBase.Columns.Add("update_date", update_dateColumnBase4);
            var versionColumnBase4 = new ColumnBase<ColumnMappingBase>("version", "uuid", drugStoreDomainProductProductTableBase);
            drugStoreDomainProductProductTableBase.Columns.Add("version", versionColumnBase4);
            relationalModel.DefaultTables.Add("DrugStore.Domain.Product.Product", drugStoreDomainProductProductTableBase);
            var drugStoreDomainProductProductMappingBase = new TableMappingBase<ColumnMappingBase>(product, drugStoreDomainProductProductTableBase, true);
            drugStoreDomainProductProductTableBase.AddTypeMapping(drugStoreDomainProductProductMappingBase, false);
            defaultTableMappings6.Add(drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase6, product.FindProperty("Id")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)category_idColumnBase1, product.FindProperty("CategoryId")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)created_dateColumnBase4, product.FindProperty("CreatedDate")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)detailColumnBase1, product.FindProperty("Detail")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)priceColumnBase0, product.FindProperty("Price")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)product_codeColumnBase, product.FindProperty("ProductCode")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)quantityColumnBase0, product.FindProperty("Quantity")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)statusColumnBase0, product.FindProperty("Status")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)titleColumnBase2, product.FindProperty("Title")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)update_dateColumnBase4, product.FindProperty("UpdateDate")!, drugStoreDomainProductProductMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)versionColumnBase4, product.FindProperty("Version")!, drugStoreDomainProductProductMappingBase);
            ...
            var pk_productsUc = RelationalModel.GetKey(this,
                "DrugStore.Domain.Product.Product",
                new[] { "Id" });
            ...
            var productImage = FindEntityType("DrugStore.Domain.Product.ProductImage")!;
            ...
            var drugStoreDomainProductProductImageTableBase = new TableBase("DrugStore.Domain.Product.ProductImage", null, relationalModel);
            var altColumnBase = new ColumnBase<ColumnMappingBase>("alt", "character varying(100)", drugStoreDomainProductProductImageTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainProductProductImageTableBase.Columns.Add("alt", altColumnBase);
            var image_urlColumnBase = new ColumnBase<ColumnMappingBase>("image_url", "character varying(100)", drugStoreDomainProductProductImageTableBase);
            drugStoreDomainProductProductImageTableBase.Columns.Add("image_url", image_urlColumnBase);
            var is_mainColumnBase = new ColumnBase<ColumnMappingBase>("is_main", "boolean", drugStoreDomainProductProductImageTableBase);
            drugStoreDomainProductProductImageTableBase.Columns.Add("is_main", is_mainColumnBase);
            var product_idColumnBase0 = new ColumnBase<ColumnMappingBase>("product_id", "uuid", drugStoreDomainProductProductImageTableBase);
            drugStoreDomainProductProductImageTableBase.Columns.Add("product_id", product_idColumnBase0);
            var titleColumnBase3 = new ColumnBase<ColumnMappingBase>("title", "character varying(100)", drugStoreDomainProductProductImageTableBase)
            {
                IsNullable = true
            };
            drugStoreDomainProductProductImageTableBase.Columns.Add("title", titleColumnBase3);
            relationalModel.DefaultTables.Add("DrugStore.Domain.Product.ProductImage", drugStoreDomainProductProductImageTableBase);
            var drugStoreDomainProductProductImageMappingBase = new TableMappingBase<ColumnMappingBase>(productImage, drugStoreDomainProductProductImageTableBase, true);
            drugStoreDomainProductProductImageTableBase.AddTypeMapping(drugStoreDomainProductProductImageMappingBase, false);
            defaultTableMappings7.Add(drugStoreDomainProductProductImageMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)product_idColumnBase0, productImage.FindProperty("ProductId")!, drugStoreDomainProductProductImageMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)altColumnBase, productImage.FindProperty("Alt")!, drugStoreDomainProductProductImageMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)image_urlColumnBase, productImage.FindProperty("ImageUrl")!, drugStoreDomainProductProductImageMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)is_mainColumnBase, productImage.FindProperty("IsMain")!, drugStoreDomainProductProductImageMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)titleColumnBase3, productImage.FindProperty("Title")!, drugStoreDomainProductProductImageMappingBase);
            ...
            var pk_product_imagesUc = RelationalModel.GetKey(this,
                "DrugStore.Domain.Product.ProductImage",
                new[] { "ProductId" });
