    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
            ...
            columns: table => new
            {
                ...
                created_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: false,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 591, DateTimeKind.Utc).AddTicks(1198)),
                update_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: true,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 591, DateTimeKind.Utc).AddTicks(1452)),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                created_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: false,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 591, DateTimeKind.Utc).AddTicks(5583)),
                update_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: true,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 591, DateTimeKind.Utc).AddTicks(5957)),
                version = table.Column<Guid>(type: "uuid", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                created_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: false,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 591, DateTimeKind.Utc).AddTicks(2858)),
                update_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: true,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 591, DateTimeKind.Utc).AddTicks(3076)),
                version = table.Column<Guid>(type: "uuid", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                created_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: false,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 592, DateTimeKind.Utc).AddTicks(8417)),
                update_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: true,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 592, DateTimeKind.Utc).AddTicks(8746)),
                version = table.Column<Guid>(type: "uuid", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                created_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: false,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 593, DateTimeKind.Utc).AddTicks(1208)),
                update_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: true,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 593, DateTimeKind.Utc).AddTicks(1559)),
                version = table.Column<Guid>(type: "uuid", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                created_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: false,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 592, DateTimeKind.Utc).AddTicks(4075)),
                update_date =
                    table.Column<DateTime>(type: "timestamp with time zone", nullable: true,
                        defaultValue: new DateTime(2024, 2, 24, 15, 2, 2, 592, DateTimeKind.Utc).AddTicks(4680)),
                version = table.Column<Guid>(type: "uuid", nullable: false)
            },
            constraints: table =>
            {
